...
class HomeCard extends StatefulWidget {
  ...
  const HomeCard({Key? key, required this.posts}) : super(key: key);
  final Post posts;
            ...
            child: ShaderMask(
              ...
              child: Container(
                ...
                child: CachedNetworkImage(
                  ...
                  placeholder:(context, url) => const Image(image: AssetImage("assets/images/placeholder-image.png"), fit: BoxFit.cover),
                  fit: BoxFit.cover,
                ),
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      CircleAvatar(
                        backgroundImage: AssetImage(widget.posts.image),
                        radius: 25,
                      ),
                      SizedBox(
                        width: 10,
